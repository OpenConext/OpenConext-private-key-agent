...
# Development configuration generated by tools/setup-dev.sh.
#
# Tokens in this file are plaintext and never expire, and the agent serves
# plain HTTP. Read SECURITY.md before running the agent anywhere other than
# your own machine.
